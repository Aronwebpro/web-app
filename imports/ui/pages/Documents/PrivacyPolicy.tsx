            ...
            <>
                <section className="content">
                    <div className="inner-content">
                        ...
                        <div>
                            <p>Apps Brewer ("us", "we", or "our") operates the https://www.iamappbrewer.com website (the "Service").</p>
                            ...
                            <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of
                                ...
                                Privacy Policy have the same meanings as in our Terms and Conditions, accessible from https://www.iamappbrewer.com</p>
                            <h2>Information Collection And Use</h2>
                            <p>We collect several different types of information for various purposes to provide and improve our Service to you.</p>
                            <h3>Types of Data Collected</h3>
                            <h4>Personal Data</h4>
                            <p>While using our Service login with LinkedIn, we will collect certain personally identifiable information that can be used
                            ...
                            <h2>Use of Data</h2>
                            <p>Apps Brewer uses the collected data for these purposes:</p>
                            <ul>
                                <li>To identify user</li>
                                <li>To show relevant content</li>
                                <li>Personalize website experience</li>
                            </ul>
                            <h2>Transfer Of Data</h2>
                            <p>Apps Brewer will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
                            ...
                            <ul>
                                <li>By visiting this page on our website: https://www.iamappbrewer.com</li>
                            </ul>
